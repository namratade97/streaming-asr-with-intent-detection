...
# Copy the updated prepare.sh into the container
COPY prepare.sh /workspace/icefall/egs/librispeech/ASR/prepare.sh
COPY compute_fbank_librispeech.py /workspace/icefall/egs/librispeech/ASR/local/compute_fbank_librispeech.py
