...
#        - 4-gram.arpa.gz
#        - 4-gram.arpa
#        - librispeech-vocab.txt#        - librispeech-lexicon.txt
#        - librispeech-lm-norm.txt.gz

dl_dir=$PWD/download

. "egs/librispeech/ASR/shared/parse_options.sh" || exit 1
...
if [ $stage -le -1 ] && [ $stop_stage -ge -1 ]; then
  ...
  if [ ! -e $dl_dir/lm/.done ]; then
    ...
    egs/librispeech/ASR/local/download_lm.py --out-dir=$dl_dir/lm
...
if [ $stage -le 3 ] && [ $stop_stage -ge 3 ]; then
  ...
  if [ ! -e data/fbank/.librispeech-validated.done ]; then
    ...
    for part in ${parts[@]}; do
      ...
      python3 egs/librispeech/ASR/local/validate_manifest.py \
...
if [ $stage -le 6 ] && [ $stop_stage -ge 6 ]; then
  ...
  if [ ! -f $lang_dir/L_disambig.pt ]; then
    ...
    egs/librispeech/ASR/local/prepare_lang.py --lang-dir $lang_dir
  fi

  if [ ! -f $lang_dir/L.fst ]; then
    log "Converting L.pt to L.fst"
    # ./shared/convert-k2-to-openfst.py \
    egs/librispeech/ASR/shared/convert-k2-to-openfst.py \
      --olabels aux_labels \
      $lang_dir/L.pt \
      $lang_dir/L.fst
  fi
