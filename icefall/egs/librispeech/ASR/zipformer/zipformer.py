...
class Zipformer2(EncoderInterface):
    ...
    def forward(
        ...
        for i, module in enumerate(self.encoders):
            ...
            outputs.append(x)
            # stack the layers
            # initiate vector as the same size as num layers
            # pass the vector through softmax
            # multiply the stacked outputs  * vector
            # sum over dim (stacked)

            # this is the enc output to feed to intent layer
