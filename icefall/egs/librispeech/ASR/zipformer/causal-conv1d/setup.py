...
FORCE_CXX11_ABI = os.getenv("CAUSAL_CONV1D_FORCE_CXX11_ABI", "FALSE") == "TRUE" or os.getenv("_GLIBCXX_USE_CXX11_ABI") == "1"
...
if not SKIP_CUDA_BUILD:
    ...
    # torch._C._GLIBCXX_USE_CXX11_ABI = bool(os.getenv("CAUSAL_CONV1D_FORCE_CXX11_ABI", "FALSE") == "TRUE")
    # torch._C._GLIBCXX_USE_CXX11_ABI = bool(int(os.getenv("_GLIBCXX_USE_CXX11_ABI", "0")))
    # torch._C._GLIBCXX_USE_CXX11_ABI = os.getenv("CAUSAL_CONV1D_FORCE_CXX11_ABI") == "TRUE"
...
setup(
    ...
    install_requires=[
        # "torch",
        "torch==2.4.0+cu121",  # <- pin exact version
        "packaging",
        "ninja",
    ],
)
