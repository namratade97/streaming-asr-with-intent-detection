...
def run(rank, world_size, args):
    ...
    if params.full_libri:
        ...
        # train_cuts = librispeech.gigaspeech_subset_small_cuts()
        # train_cuts = librispeech.train_multiple_cuts() #############################################
    ...
    # valid_cuts = librispeech.gigaspeech_dev_cuts()
    valid_cuts = librispeech.dev_clean_cuts()
    valid_cuts += librispeech.dev_other_cuts()
    valid_cuts += slurp.dev_clean_cuts() 
